...
class GraspingDemo:
    ...
    def attainObject(self):
        ...
        self.attainPosition(self.obj_robot_frame.point.x, self.obj_robot_frame.point.y, self.obj_robot_frame.point.z)
...
if __name__ == '__main__':
    ...
    pregrasp_z = rospy.get_param('pregrasp_z', default=0.30)
